...
class TransfG(object):
    def __init__(self, sequence_length, num_hidden_layers, vocab_size, feature_dim_size, batch_size, num_heads,
                 ff_hidden_size, initialization, num_sampled, num_neighbors, use_pos=1):
        ...
        self.inputTransfG = tf.nn.l2_normalize(self.inputTransfG, axis=2)
        ...
        self.outputEncoder = tf.nn.l2_normalize(self.outputEncoder, axis=2)
